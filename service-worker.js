...
const CACHE_NAME = "barcode-inventory-app-v124";
const APP_FILES = [
  ...
  "./scanner.js?v=88", "./stocktaking.js?v=124",
  ...
  "./home-dashboard.js?v=123", "./app-settings.js?v=102", "./pwa.js?v=31", "./manifest.json",
