...
const CACHE_NAME = "barcode-inventory-app-v37";
const APP_FILES = [
  ...
  "./sales-plan.js?v=37", "./backup.js?v=34", "./restore.js?v=34", "./location-management.js?v=32",
  "./home-dashboard.js?v=37", "./pwa.js?v=31", "./manifest.json",
