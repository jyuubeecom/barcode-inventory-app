...
const CACHE_NAME = "barcode-inventory-app-v225";
const APP_FILES = [
  ...
  "./sales-plan.js?v=225", "./sales-actual.js?v=210", "./purchase-required.js?v=206", "./order-remaining.js?v=120", "./low-shipment.js?v=206",
