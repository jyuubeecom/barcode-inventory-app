...
const CACHE_NAME = "barcode-inventory-app-v47";
const APP_FILES = [
  ...
  "./sales-plan.js?v=37", "./sales-actual.js?v=39", "./purchase-required.js?v=46", "./low-shipment.js?v=45", "./shipping-wish.js?v=42", "./shipping-schedule.js?v=47", "./backup.js?v=47", "./restore.js?v=47", "./location-management.js?v=32",
