...
const CACHE_NAME = "barcode-inventory-app-v51";
const APP_FILES = [
  ...
  "./shipping-schedule.js?v=51", "./shipping-arrival.js?v=51", "./barcode-print.js?v=50",
  "./backup.js?v=51", "./restore.js?v=51", "./location-management.js?v=32",
